...
void	tokenizer_char_handler(t_tokenizer *t)
{
	...
	{T_TT_REDIRECTION_IN, tokenizer_delimit_new, T_TT_WORD},
	{T_TT_REDIRECTION_OUT, tokenizer_delimit_new, T_TT_WORD},
	{T_TT_REDIRECTION_APPEND, tokenizer_delimit_new, T_TT_WORD},
